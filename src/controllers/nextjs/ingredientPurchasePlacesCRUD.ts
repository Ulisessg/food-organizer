...
} from '../sql/WithPrisma/ingredientPurchasePlaces/createIngredientPurchasePlacesSql'
import { type TIngr_purchase_places } from '../sql/WithPrisma/ingredients/getIngredientsSql'
import type { ingredient_purchase_places } from '@prisma/client'
import { type response } from 'controllers/response'

import updateIngredientPurchasePlaceSql
  from '../sql/WithPrisma/ingredientPurchasePlaces/updateIngredientPurchasePlacesSql'
