...
import CreateIngredientStock from 'components/web/ingredientStock/CreateIngredientStock'
import DisplayIngredientsStock from 'components/web/ingredientStock/DisplayIngredientsStock'
